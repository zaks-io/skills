...
- Do not move the issue to `In Review`; that happens after PR creation.
- Do not move an issue to merge-ready state unless Agent Review or the user
  asked you to manage tracker state.
